...
class HeatmapTests(unittest.TestCase):
    ...
    def test_rendered_html_contains_viewer_controls(self) -> None:
        ...
        self.assertIn("L.gridLayer", html)
        self.assertIn("createTile", html)
        self.assertIn("buildCellIndex", html)
        self.assertIn("MAX_BUCKET_QUERY_SCAN", html)
        self.assertIn("drawCellBridges", html)
        self.assertIn("drawFrequencyRouteStrokes", html)
        self.assertIn("routeStrokeMode", html)
        self.assertIn("frequencyHeatGlowAlpha", html)
        self.assertIn("routeSegmentBands", html)
        self.assertIn("cellLookup", html)
        self.assertIn('ctx.lineCap = "butt"', html)
        self.assertIn("heatRefreshTimer", html)
        self.assertIn("ROUTE_STROKE_MIN_ZOOM", html)
        self.assertIn("ROUTE_STROKE_ONLY_ZOOM", html)
        self.assertIn("heatTileCache", html)
        self.assertIn("refreshHeatLayerSoon", html)
        self.assertIn("setHeatPaneOpacity", html)
        self.assertIn("metricRange", html)
        self.assertIn("heatLayer.redraw", html)
        self.assertNotIn('"zoomend moveend"', html)
        self.assertNotIn("drawFrequencyRoutes", html)
